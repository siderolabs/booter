...
all: unit-tests booter image-booter lint
...
.PHONY: $(ARTIFACTS)/booter-linux-amd64
$(ARTIFACTS)/booter-linux-amd64:
	@$(MAKE) local-booter-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: booter-linux-amd64
booter-linux-amd64: $(ARTIFACTS)/booter-linux-amd64  ## Builds executable for booter-linux-amd64.

.PHONY: $(ARTIFACTS)/booter-linux-arm64
$(ARTIFACTS)/booter-linux-arm64:
	@$(MAKE) local-booter-linux-arm64 DEST=$(ARTIFACTS)

.PHONY: booter-linux-arm64
booter-linux-arm64: $(ARTIFACTS)/booter-linux-arm64  ## Builds executable for booter-linux-arm64.

.PHONY: booter
booter: booter-linux-amd64 booter-linux-arm64  ## Builds executables for booter.
...
.PHONY: image-booter
image-booter:  ## Builds image for booter.
	@$(MAKE) registry-$@ IMAGE_NAME="booter"
