...
#
# Generated on 2025-08-01T10:17:50Z by kres 5fb5b90.
...
WORKDIR /src
RUN --mount=type=cache,target=/root/.cache/go-build,id=booter/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=booter/go/pkg govulncheck ./...
